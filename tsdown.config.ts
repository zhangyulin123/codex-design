/**
 * tsdown build for codex-design: the host-half lib (lib/index.js and
 ...
 *   the package-name id `codex-design` (the client-modules compose
 ...
 *   `your-org/codex-design` (the registry browser-side `arrive()`
 ...
 * differing: the official channel uses the package name (`codex-design`)
 * and the registry channel uses the manifest id
 * (`your-org/codex-design`).
 ...
 *
 * Chunk css tags use the constant plugin id `codex-design` (matching
...
export default [
  ...
  clientBundle('codex-design', 'client.js'),
  // Plugin-registry channel: bundle id = manifest id (dsh.plugin.json `id`).
  clientBundle('your-org/codex-design', 'client-registry.js'),
