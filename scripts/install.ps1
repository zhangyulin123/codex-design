## =============================================================================
# codex-design 一键安装脚本（官方 CLI 方式，Windows PowerShell 5.1+ / pwsh）
#
...
# 用法（任选其一）：
#   # 默认最新版
#   $script = (irm 'https://raw.githubusercontent.com/your-org/codex-design/main/scripts/install.ps1').TrimStart([char]0xFEFF)
