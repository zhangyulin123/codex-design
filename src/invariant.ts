/**
 * Package-owned invariant companion for `codex-design`.
 * @module codex-design/invariant
 */

/* jscpd:ignore-start */
import type { Context } from './context-types.ts'

const PACKAGE_NAME = 'codex-design'

/** Cordis companion plugin name. */
export const name = 'codex-design-invariant'
