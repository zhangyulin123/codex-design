 ...
 *
 * The topic name is an ECOSYSTEM-WIDE identifier, not this package's identity:
 * the catalog's third-party plugins are published by other authors under that
 * topic (see the ecosystem tables in README.md), so the "browse more plugins"
 * button must keep pointing at the shared page. Retained deliberately — see
 * the compatibility contract in MIGRATION.md / AGENTS §0.
 */
