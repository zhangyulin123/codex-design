...
export const id: Record<string, string> = {
  ...
  pluginOfficeDesc: 'Pratinjau Office-suite (.docx / .xlsx / .pptx) untuk editor codex-design, menjaga pustaka render Office yang berat tetap di luar bundle inti',
  pluginFlowglassDesc: 'Flowgraph sesi langsung dengan tiga lajur untuk pengguna, asisten, dan panggilan alat, plus grup paralel, cabang sub-agen, drill-down, dan status langsung; mendaftarkan tab Flowglass native saat codex-design terpasang dan mempertahankan laci mandirinya sebagai fallback',
  ...
  pluginGithubWorkbenchDesc: 'Tab GitHub Workbench: pohon repo remote + Issues / Pull requests / Actions dengan dukungan tulis penuh — buat Issue/PR, komentar, edit, tutup/buka ulang, merge squash·merge·rebase (konfirmasi kuat), jalankan ulang/batalkan CI; pengalih repo otomatis mencantumkan repo yang dapat diakses dan mencari repo publik; tanpa codex-design otomatis beralih ke panel kanan mandiri',
  pluginMdExportDesc: 'Menambahkan tombol "Ekspor" ke bilah alat Markdown di codex-design: merender .md saat ini menjadi HTML mandiri dalam satu klik (tabel/blok kode/diagram Mermaid inline, tata letak mengikuti tema pratinjau) dan menyimpannya di folder yang sama, atau mengekspor ke PDF lewat dialog cetak',
  pluginCodeNavDesc: 'Navigasi pratinjau kode: mengenali bahasa dari jenis berkas dan menyorot sintaks, kerangka simbol (filter kelas/metode/variabel + lompat sekali klik), serta pencarian dalam berkas (sorot semua kecocokan, sebelum/berikutnya, peka huruf besar-kecil) — mengambil alih pratinjau berkas kode di editor codex-design',
  pluginSuhuangScrollDesc: 'Menghubungkan Suhuang Scroll Runtime lokal ke pengaturan DSH dan codex-design untuk konfigurasi model, uji koneksi, dan kontrol penilaian berkelanjutan; memerlukan Suhuang Scroll Runtime dan codex-design',
  pluginBetterOverleafDesc: 'Tab Overleaf untuk codex-design: login langsung lewat peramban CDP (mendukung Chromium pihak ketiga), daftar/pergantian proyek, mirror git lokal di <workspace>/overleaf/, sinkronisasi git dua arah dengan fallback API baca-saja, dan pratinjau berkas melalui workbench sidebar',
  ...
  pluginVideoPreviewDesc: 'Pratinjau video inline (.mp4/.webm/.mov/.mkv/.avi dll.) untuk editor codex-design, didukung oleh rute host /video khusus dengan dukungan HTTP Range (206) — scrubbing berfungsi dan berkas tidak dibatasi oleh mediaLimit 20MB',
  ...
  pluginEgoBrowserDesc: 'Browser agen untuk DeepSeek Harness: 32 alat ego_* menggerakkan Chromium sungguhan; tab «ego browser» native di bilah samping menampilkan langsung setiap halaman yang dikunjungi agen — Anda bisa mengklik, menyeret, dan mengetik untuk mengambil alih. Tab terdaftar otomatis jika codex-design terpasang; jika tidak, jatuh ke gelembung mengambang',
  ...
  codexThemeDesc: 'Menerapkan palet Codex asli terminal (kanvas nyaris hitam, aksen hijau khas) ke seluruh antarmuka Harness.',
  codexThemeApply: 'Terapkan tema Codex',
  codexThemeRestore: 'Ikuti terang / gelap sistem',
  codexThemeActive: 'Tema Codex aktif',
  codexSessions: 'Sesi',
  codexActiveSessions: 'Sesi saat ini',
  codexArchived: 'Diarsipkan',
  codexArchivedEmpty: 'Belum ada sesi yang diarsipkan',
  codexRestore: 'Pulihkan',
  codexDelete: 'Hapus',
  codexDeleteConfirm: 'Hapus sesi «{name}» secara permanen? Riwayat percakapan sesi ini akan dihapus dan tidak dapat dipulihkan.',
  codexUnarchiveFailed: 'Gagal memulihkan',
  codexDeleteFailed: 'Gagal menghapus',
  codexTokens: 'Token desain',
  codexTokensDesc: 'Token antarmuka yang ditimpa oleh tema Codex: kanvas nyaris hitam, garis rambut, aksen hijau terminal.',
  codexViewerTitle: 'Desain Codex',
  codexViewerEmpty: 'Tidak ada token desain yang dikenali di berkas ini.',
}
