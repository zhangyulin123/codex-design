/**
 * German dictionary for codex-design.
 */
export const de: Record<string, string> = {
  ...
  pluginFlowglassDesc: 'Live-Sitzungsflussdiagramm: dreispurige Darstellung von Benutzer, Assistent und Werkzeugaufrufen mit parallelen Gruppen, Subagent-Zweigen, Drill-down und Live-Status; registriert bei installiertem codex-design einen nativen „Flowglass“-Tab und behält sonst eine eigenständige Schublade',
  ...
  pluginGithubWorkbenchDesc: '„GitHub Workbench“-Tab: Repository-Baum + Issues / Pull requests / Actions mit vollen Schreibrechten — Issue/PR erstellen, kommentieren, bearbeiten, schließen/wieder öffnen, squash·merge·rebase-Merge (mit starker Bestätigung), CI erneut ausführen/abbrechen; der Repo-Umschalter listet automatisch zugreifbare Repos auf und durchsucht öffentliche; ohne codex-design fällt er auf ein eigenständiges rechtes Panel zurück',
  pluginMdExportDesc: 'Fügt einen „Export"-Button zur Markdown-Symbolleiste in codex-design hinzu: rendert die aktuelle .md per Klick in eigenständiges HTML (Tabellen/Codeblöcke/Mermaid-Diagramme inline, Layout folgt dem Vorschau-Theme) und speichert es neben der .md, oder exportiert über den Druckdialog als PDF',
  ...
  pluginSuhuangScrollDesc: 'Verbindet die lokale Suhuang Scroll Runtime mit den DSH-Einstellungen und codex-design für Modellkonfiguration, Verbindungstests und fortlaufende Bewertung; benötigt Suhuang Scroll Runtime und codex-design',
  pluginBetterOverleafDesc: 'Overleaf-Tab für codex-design: Login direkt über CDP-Browser (Chromium von Drittanbietern unterstützt), Projekliste/-wechsel, lokale git-Spiegel unter <workspace>/overleaf/, bidirektionaler git-Abgleich mit Read-only-API-Fallback und Dateivorschau über die Sidebar-Workbench',
  ...
  pluginServerDeckDesc: 'Server-Karten-Dashboard: eine Karte pro Host mit Onlinestatus, OS, Uptime sowie CPU-/RAM-/Festplattenauslastung und Latenz; ein Klick öffnet ein interaktives xterm.js-Terminal; ~/.ssh/config-Import mit einem Klick (Git-Hosting-Aliase werden übersprungen). Registriert einen nativen „Server“-Tab bei installiertem codex-design, sonst bleibt der eigenständige Drawer erhalten',
  ...
  pluginEgoBrowserDesc: 'Der Agent-Browser für DeepSeek Harness: 32 ego_*-Tools steuern ein echtes Chromium; ein nativer „ego-Browser“-Tab in der Seitenleiste zeigt live jede Seite, die der Agent besucht – Klicken, Ziehen und Tippen zum Übernehmen. Registriert den Tab automatisch, wenn codex-design vorhanden ist, sonst eine schwebende Blase',
  ...
  codexThemeDesc: 'Wendet die terminaleigene Codex-Palette (fast schwarze Fläche, charakteristischer grüner Akzent) auf die gesamte Harness-Oberfläche an.',
  codexThemeApply: 'Codex-Theme anwenden',
  codexThemeRestore: 'System-Hell/Dunkel folgen',
  codexThemeActive: 'Codex-Theme ist aktiv',
  codexSessions: 'Sitzungen',
  codexActiveSessions: 'Aktuelle Sitzungen',
  codexArchived: 'Archiviert',
  codexArchivedEmpty: 'Keine archivierten Sitzungen',
  codexRestore: 'Wiederherstellen',
  codexDelete: 'Löschen',
  codexDeleteConfirm: 'Sitzung „{name}“ endgültig löschen? Der Gesprächsverlauf dieser Sitzung wird entfernt und kann nicht wiederhergestellt werden.',
  codexUnarchiveFailed: 'Wiederherstellen fehlgeschlagen',
  codexDeleteFailed: 'Löschen fehlgeschlagen',
  codexTokens: 'Design-Tokens',
  codexTokensDesc: 'UI-Tokens, die das Codex-Theme überschreibt: fast schwarze Fläche, Haarlinien-Konturen, terminalgrüner Akzent.',
  codexViewerTitle: 'Codex-Design',
  codexViewerEmpty: 'In dieser Datei wurden keine erkennbaren Design-Tokens gefunden.',
}
