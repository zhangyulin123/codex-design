export const sv: Record<string, string> = {
  ...
  pluginFlowglassDesc: 'Live sessionsflödesgraf med tre banor för användare, assistent och verktygsanrop, plus parallella grupper, subagent-grenar, djupdykning och live-status; registrerar en inbyggd Flowglass-flik när codex-design är installerat och behåller sin fristående låda som reserv',
  ...
  pluginGithubWorkbenchDesc: 'GitHub Workbench-flik: fjärrrepo-träd + Issues / Pull requests / Actions med fullt skrivstöd — skapa issue/PR, kommentera, redigera, stäng/öppna igen, squash·merge·rebase-merge (stark bekräftelse), kör om/avbryt CI; repoväxlaren listar automatiskt tillgängliga repon och söker i publika; utan codex-design växlar den till en fristående höger panel',
  pluginMdExportDesc: 'Lägger till en «Exportera»-knapp i Markdown-verktygsfältet i codex-design: renderar nuvarande .md till fristående HTML i ett klick (tabeller/kodblock/Mermaid-diagram inline, layout följer förhandsvisningstemat) och sparar bredvid .md-filen, eller exporterar till PDF via utskriftsdialogen',
  ...
  pluginSuhuangScrollDesc: 'Ansluter den lokala Suhuang Scroll Runtime till DSH-inställningar och codex-design för modellkonfiguration, anslutningstest och styrning av kontinuerlig rättning; kräver Suhuang Scroll Runtime och codex-design',
  pluginBetterOverleafDesc: 'Overleaf-flik för codex-design: direktinloggning via CDP-webbläsare (stöd för tredjeparts-Chromium), projektlista/byte, lokala git-speglar under <workspace>/overleaf/, dubbelriktad git-synk med read-only-API-fallback och förhandsvisning av filer via sidofältets workbench',
  ...
  pluginServerDeckDesc: 'Serverkortspanel: ett kort per värd med onlinestatus, OS, drifttid, CPU-/minnes-/diskanvändning och latens; klicka på ett kort för att öppna en interaktiv xterm.js-terminal; import av ~/.ssh/config i ett klick (git-hostingalias hoppas över). Registrerar en nativ flik 「Servrar」 när codex-design är installerat, annars behålls den fristående panelen',
  ...
  pluginEgoBrowserDesc: 'Agentwebbläsaren för DeepSeek Harness: 32 ego_*-verktyg styr en riktig Chromium; en inbyggd «ego browser»-flik i sidopanelen visar varje sida agenten besöker i realtid — du kan klicka, dra och skriva för att ta över. Registrerar fliken automatiskt när codex-design finns, annars en flytande bubbla',
  ...
  codexThemeTitle: 'Codex-tema',
  codexThemeDesc: 'Tillämpar terminalens inbyggda Codex-palett (nästan svart canvas, den karakteristiska gröna accenten) på hela Harness-gränssnittet.',
  codexThemeApply: 'Använd Codex-temat',
  codexThemeRestore: 'Följ systemets ljust / mörkt',
  codexThemeActive: 'Codex-temat är aktivt',
  codexSessions: 'Sessioner',
  codexActiveSessions: 'Aktuella sessioner',
  codexArchived: 'Arkiverade',
  codexArchivedEmpty: 'Inga arkiverade sessioner',
  codexRestore: 'Återställ',
  codexDelete: 'Ta bort',
  codexDeleteConfirm: 'Ta bort sessionen «{name}» permanent? Konversationsloggen för sessionen tas bort och kan inte återställas.',
  codexUnarchiveFailed: 'Återställningen misslyckades',
  codexDeleteFailed: 'Borttagningen misslyckades',
  codexTokens: 'Designtokens',
  codexTokensDesc: 'Gränssnittstokens som Codex-temat åsidosätter: nästan svart canvas, hårlinjer, terminalgrön accent.',
  codexViewerTitle: 'Codex-design',
  codexViewerEmpty: 'Inga igenkännbara designtokens i den här filen.',
}
