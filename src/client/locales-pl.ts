...
export const pl: Record<string, string> = {
  ...
  pluginOfficeDesc: 'Podgląd pakietu Office (.docx / .xlsx / .pptx) dla edytora codex-design, utrzymujący ciężkie biblioteki renderujące Office poza rdzeniem głównego pakietu',
  pluginFlowglassDesc: 'Wykres przepływu sesji na żywo: trzy tory dla użytkownika, asystenta i wywołań narzędzi, z grupami równoległymi, gałęziami podagentów, drążeniem i statusem na żywo; rejestruje natywną kartę Flowglass po zainstalowaniu codex-design, z fallbackiem do samodzielnej szuflady',
  ...
  pluginGithubWorkbenchDesc: 'Karta GitHub Workbench: drzewo zdalnego repozytorium + Issues / Pull requests / Actions z pełną obsługą zapisu — tworzenie issue/PR, komentowanie, edycja, zamykanie/ponowne otwieranie, scalanie squash·merge·rebase (mocne potwierdzenie), ponowne uruchomienie/anulowanie CI; przełącznik repozytoriów automatycznie wyświetla dostępne repozytoria i wyszukuje publiczne; bez codex-design następuje przejście na samodzielny panel po prawej stronie',
  pluginMdExportDesc: 'Dodaje przycisk „Eksportuj" do paska narzędzi Markdown w codex-design: jednym kliknięciem renderuje bieżący .md do samodzielnego HTML (tabele/bloki kodu/diagramy Mermaid w treści, układ zgodny z motywem podglądu) i zapisuje obok pliku .md albo eksportuje do PDF przez okno drukowania',
  pluginCodeNavDesc: 'Nawigacja podglądu kodu: rozpoznaje język po typie pliku i koloruje składnię, konspekt symboli (filtry klas/metod/zmiennych + skok jednym kliknięciem) oraz wyszukiwanie w pliku (podświetlanie wszystkich trafień, poprzedni/następny, rozróżnianie wielkości liter) — przejmuje podgląd plików kodu w edytorze codex-design',
  pluginSuhuangScrollDesc: 'Łączy lokalny Suhuang Scroll Runtime z ustawieniami DSH i codex-design, zapewniając konfigurację modelu, test połączenia i sterowanie ciągłym ocenianiem; wymaga Suhuang Scroll Runtime i codex-design',
  pluginBetterOverleafDesc: 'Karta Overleaf dla codex-design: logowanie bezpośrednio przez przeglądarkę CDP (obsługa Chromium innych firm), lista/przełączanie projektów, lokalne kopie lustrzane git w <workspace>/overleaf/, dwukierunkowa synchronizacja git z awaryjnym API tylko do odczytu oraz podgląd plików przez warsztat panelu bocznego',
  ...
  pluginVideoPreviewDesc: 'Wbudowany podgląd plików wideo (.mp4/.webm/.mov/.mkv/.avi itp.) w edytorze codex-design, wspierany przez dedykowaną trasę hosta /video z obsługą HTTP Range (206) — przewijanie działa, a pliki nie są ograniczane przez mediaLimit 20 MB',
  ...
  codexThemeTitle: 'Motyw Codex',
  codexThemeDesc: 'Stosuje terminalową paletę Codex (prawie czarne tło, charakterystyczny zielony akcent) do całego interfejsu Harness.',
  codexThemeApply: 'Zastosuj motyw Codex',
  codexThemeRestore: 'Zgodnie z jasnym / ciemnym systemu',
  codexThemeActive: 'Motyw Codex jest aktywny',
  codexSessions: 'Sesje',
  codexActiveSessions: 'Bieżące sesje',
  codexArchived: 'Zarchiwizowane',
  codexArchivedEmpty: 'Brak zarchiwizowanych sesji',
  codexRestore: 'Przywróć',
  codexDelete: 'Usuń',
  codexDeleteConfirm: 'Trwale usunąć sesję «{name}»? Dziennik rozmowy tej sesji zostanie usunięty i nie będzie można go odzyskać.',
  codexUnarchiveFailed: 'Przywracanie nie powiodło się',
  codexDeleteFailed: 'Usuwanie nie powiodło się',
  codexTokens: 'Tokeny projektu',
  codexTokensDesc: 'Tokeny interfejsu nadpisywane przez motyw Codex: prawie czarne tło, cienkie linie, terminalowy zielony akcent.',
  codexViewerTitle: 'Projekt Codex',
  codexViewerEmpty: 'W tym pliku nie ma rozpoznawalnych tokenów projektu.',
}
