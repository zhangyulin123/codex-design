...
export const nl: Record<string, string> = {
  ...
  pluginFlowglassDesc: 'Live sessie-flowgraph met drie banen voor gebruiker, assistent en tool-aanroepen, plus parallelle groepen, subagent-takken, drill-down en live status; registreert een native Flowglass-tabblad wanneer codex-design is geïnstalleerd en behoudt zijn standalone lade als fallback',
  ...
  pluginGithubWorkbenchDesc: 'GitHub Workbench-tab: externe repositoryboom + Issues / Pull requests / Actions met volledige schrijfontsteuning — issue/PR aanmaken, reageren, bewerken, sluiten/heropenen, squash·merge·rebase-merge (sterke bevestiging), CI opnieuw uitvoeren/annuleren; de repo-wisselaar toont automatisch toegankelijke repo’s en doorzoekt openbare; zonder codex-design valt het terug op een zelfstandig rechterpaneel',
  pluginMdExportDesc: 'Voegt een knop «Exporteren» toe aan de Markdown-werkbalk van codex-design: rendert de huidige .md in één klik naar zelfstandige HTML (tabellen/codeblokken/Mermaid-diagrammen inline, lay-out volgt het voorbeeldthema) en slaat die naast het .md op, of exporteert via het afdrukvenster naar PDF',
  ...
  pluginSuhuangScrollDesc: 'Verbindt de lokale Suhuang Scroll Runtime met DSH-instellingen en codex-design voor modelconfiguratie, verbindingstests en doorlopende beoordelingsbediening; vereist Suhuang Scroll Runtime en codex-design',
  pluginBetterOverleafDesc: 'Overleaf-tabblad voor codex-design: directe browserlogin via CDP (ondersteunt Chromium van derden), projectlijst/wisselen, lokale git-spiegels onder <workspace>/overleaf/, tweerichtingssynchronisatie met read-only-API-terugval en bestandsvoorbeeld via de sidebar-werkbank',
  ...
  codexThemeTitle: 'Codex-thema',
  codexThemeDesc: 'Past het terminaleigen Codex-palet (bijna zwart canvas, kenmerkend groen accent) toe op de hele Harness-interface.',
  codexThemeApply: 'Codex-thema toepassen',
  codexThemeRestore: 'Systeem licht / donker volgen',
  codexThemeActive: 'Codex-thema is actief',
  codexSessions: 'Sessies',
  codexActiveSessions: 'Huidige sessies',
  codexArchived: 'Gearchiveerd',
  codexArchivedEmpty: 'Geen gearchiveerde sessies',
  codexRestore: 'Herstellen',
  codexDelete: 'Verwijderen',
  codexDeleteConfirm: 'Sessie «{name}» permanent verwijderen? Het gesprekslogboek van deze sessie wordt verwijderd en kan niet worden hersteld.',
  codexUnarchiveFailed: 'Herstellen mislukt',
  codexDeleteFailed: 'Verwijderen mislukt',
  codexTokens: 'Ontwerptokens',
  codexTokensDesc: 'UI-tokens die het Codex-thema overschrijft: bijna zwart canvas, haarlijnranden, terminalgroen accent.',
  codexViewerTitle: 'Codex-ontwerp',
  codexViewerEmpty: 'Geen herkenbare ontwerptokens in dit bestand.',
}
