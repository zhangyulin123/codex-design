/**
 * French translation of the codex-design copy.
 *
...
export const fr: Record<string, string> = {
  ...
  pluginOfficeDesc: 'Aperçu de la suite Office (.docx / .xlsx / .pptx) pour l’éditeur codex-design, avec les lourdes bibliothèques de rendu Office extraites du package principal et installées à la demande',
  pluginFlowglassDesc: 'Schéma de flux de session en temps réel : trois couloirs pour l’utilisateur, l’assistant et les appels d’outils, avec regroupement en parallèle, branches de sous-agents, exploration par niveau et états en temps réel ; enregistre l’onglet natif « Flowglass » une fois codex-design installé, sinon conserve un tiroir indépendant',
  pluginGitForgeDesc: 'Onglet « Identifiants Git » de codex-design : bibliothèque de comptes GitHub/Gitea (et autres forges) + autorisations par projet + blocage strict des stratégies push ; les tokens restent dans les secrets locaux, jamais dans le contexte du modèle ; fournit un outil GitForge en lecture seule et un helper HTTPS de credentials pour l’agent',
  pluginGithubWorkbenchDesc: 'Onglet « GitHub Workbench » de codex-design : arborescence du dépôt distant + Issues / Pull requests / Actions avec prise en charge complète en écriture — création d’issue/PR, commentaire, édition, fermeture/réouverture, merge squash·merge·rebase (confirmation renforcée), relance/annulation de la CI ; le sélecteur de dépôt liste automatiquement les dépôts accessibles et recherche les dépôts publics ; sans codex-design, il bascule sur un panneau latéral droit autonome',
  pluginMdExportDesc: 'Ajoute un bouton « Exporter » à la barre d’outils Markdown de codex-design : rend en un clic le .md courant en HTML autonome (tableaux/blocs de code/diagrammes Mermaid en ligne, mise en page fidèle au thème d’aperçu) et l’enregistre à côté du .md, ou exporte en PDF via la boîte de dialogue d’impression',
  pluginCodeNavDesc: 'Navigation de prévisualisation de code : détecte le langage selon le type de fichier et colore la syntaxe, plan des symboles (filtres classes/méthodes/variables + saut en un clic) et recherche dans le fichier (toutes les correspondances surlignées, précédent/suivant, respect de la casse) — prend en charge l’aperçu des fichiers de code dans l’éditeur codex-design',
  pluginSuhuangScrollDesc: 'Connecte le Runtime Suhuang Scroll local aux réglages DSH et à codex-design pour configurer le modèle, tester la connexion et contrôler la correction continue ; nécessite Suhuang Scroll Runtime et codex-design',
  pluginBetterOverleafDesc: 'Onglet Overleaf pour codex-design : connexion directe via navigateur CDP (Chromium tiers pris en charge), liste/sélection de projets, miroirs git locaux sous <workspace>/overleaf/, synchronisation git bidirectionnelle avec repli API en lecture seule, et aperçu des fichiers via l’atelier de la barre latérale',
  pluginGitRemotesDesc: 'Onglet Git Remotes de codex-design : branches/amonts/ahead-behind, fetch (avec prune possible), pull en ff-only, push seulement après confirmation. Ne remplace pas la mise en scène/les commits du Git intégré et ne fournit pas de force-push ni de push automatique par le modèle',
  ...
  pluginSshTunnelDesc: 'Onglet « Tunnel SSH » de codex-design : inventaire multi-machines + autorisations par projet + clés conservées localement ; outil de modèle SSHManager (exec/SFTP/stratégies de session) ; terminal interactif central et SFTP à deux volets',
  ...
  pluginVideoPreviewDesc: 'Aperçu vidéo en ligne dans l’éditeur codex-design (.mp4/.webm/.mov/.mkv/.avi, etc.), avec une route hôte /video prenant en charge HTTP Range (206) ; barre de progression déplaçable, non limité par la mediaLimit de 20 Mo',
  ...
  pluginEgoBrowserDesc: 'Le navigateur d’agent pour DeepSeek Harness : 32 outils ego_* pilotent un vrai Chromium ; un onglet natif « ego browser » dans la barre latérale montre en direct chaque page visitée par l’agent — cliquez, glissez et tapez pour reprendre la main. Enregistre l’onglet automatiquement si codex-design est présent, sinon une bulle flottante',
  ...
  codexThemeTitle: 'Thème Codex',
  codexThemeDesc: 'Applique la palette Codex native du terminal (canevas presque noir, accent vert emblématique) à toute l’interface de Harness.',
  codexThemeApply: 'Appliquer le thème Codex',
  codexThemeRestore: 'Suivre le clair / sombre du système',
  codexThemeActive: 'Le thème Codex est actif',
  codexSessions: 'Sessions',
  codexActiveSessions: 'Sessions en cours',
  codexArchived: 'Archivées',
  codexArchivedEmpty: 'Aucune session archivée',
  codexRestore: 'Restaurer',
  codexDelete: 'Supprimer',
  codexDeleteConfirm: 'Supprimer définitivement la session « {name} » ? Le journal de conversation de cette session sera supprimé et ne pourra pas être récupéré.',
  codexUnarchiveFailed: 'Échec de la restauration',
  codexDeleteFailed: 'Échec de la suppression',
  codexTokens: 'Jetons de design',
  codexTokensDesc: 'Jetons d’interface que le thème Codex remplace : canevas presque noir, traits fins, accent vert de terminal.',
  codexViewerTitle: 'Design Codex',
  codexViewerEmpty: 'Aucun jeton de design reconnaissable dans ce fichier.',
}
