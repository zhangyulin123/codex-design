export const pt: Record<string, string> = {
  ...
  pluginOfficeDesc: 'Pré-visualização do pacote Office (.docx / .xlsx / .pptx) para o editor do codex-design, mantendo as bibliotecas pesadas de renderização do Office fora do bundle principal',
  pluginFlowglassDesc: 'Fluxograma de sessão ao vivo com três faixas para usuário, assistente e chamadas de ferramenta, além de grupos paralelos, ramos de subagentes, drill-down e status ao vivo; registra uma aba nativa "Fluxograma" quando o codex-design está instalado e mantém a gaveta independente como fallback',
  ...
  pluginVideoPreviewDesc: 'Pré-visualização inline de vídeo (.mp4/.webm/.mov/.mkv/.avi etc.) para o editor do codex-design, respaldada por uma rota de host /video dedicada com suporte a HTTP Range (206) — a barra de progresso funciona e os arquivos não são limitados pelo mediaLimit de 20MB',
  ...
  codexThemeDesc: 'Aplica a paleta Codex nativa do terminal (tela quase preta, acento verde característico) a toda a interface do Harness.',
  codexThemeApply: 'Aplicar tema Codex',
  codexThemeRestore: 'Seguir claro / escuro do sistema',
  codexThemeActive: 'O tema Codex está ativo',
  codexSessions: 'Sessões',
  codexActiveSessions: 'Sessões atuais',
  codexArchived: 'Arquivadas',
  codexArchivedEmpty: 'Nenhuma sessão arquivada',
  codexRestore: 'Restaurar',
  codexDelete: 'Excluir',
  codexDeleteConfirm: 'Excluir permanentemente a sessão «{name}»? O histórico de conversa dessa sessão será removido e não poderá ser recuperado.',
  codexUnarchiveFailed: 'Falha ao restaurar',
  codexDeleteFailed: 'Falha ao excluir',
  codexTokens: 'Tokens de design',
  codexTokensDesc: 'Tokens de interface que o tema Codex substitui: tela quase preta, traços finos, acento verde de terminal.',
  codexViewerTitle: 'Design Codex',
  codexViewerEmpty: 'Nenhum token de design reconhecível neste arquivo.',
}
