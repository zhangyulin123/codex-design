...
export const hi: Record<string, string> = {
  ...
  pluginOfficeDesc: 'codex-design एडिटर के लिए Office-सूट पूर्वावलोकन (.docx / .xlsx / .pptx), भारी Office रेंडर लाइब्रेरीज़ को मुख्य बंडल से बाहर रखता है',
  pluginFlowglassDesc: 'लाइव सत्र फ़्लोग्राफ़: उपयोगकर्ता, सहायक और टूल कॉल के लिए तीन लेन, समानांतर समूह, सबएजेंट शाखाएँ, ड्रिल-डाउन और लाइव स्थिति; codex-design इंस्टॉल होने पर देशी Flowglass टैब पंजीकृत करता है और फ़ॉलबैक के रूप में स्टैंडअलोन दराज रखता है',
  ...
  pluginGithubWorkbenchDesc: 'GitHub Workbench टैब: रिमोट रिपॉज़िटरी ट्री + Issues / Pull requests / Actions, पढ़ने के साथ-साथ पूर्ण लेखन समर्थन — Issue/PR बनाना, टिप्पणी करना, संपादन, बंद करना/पुनः खोलना, squash·merge·rebase मर्ज (पुष्टि अनिवार्य), CI पुनः चलाना/रद्द करना; रिपॉज़िटरी स्विचर स्वतः सुलभ रिपॉज़िटरी सूचीबद्ध करता है और सार्वजनिक रिपॉज़िटरी खोजता है; codex-design न होने पर स्वतंत्र दाईं ओर पैनल में फ़ॉलबैक होता है',
  pluginMdExportDesc: 'codex-design के Markdown टूलबार में "एक्सपोर्ट" बटन जोड़ता है: एक क्लिक में वर्तमान .md को स्टैंडअलोन HTML (टेबल/कोड ब्लॉक/Mermaid आरेख इनलाइन, लेआउट प्रीव्यू थीम का अनुसरण करता है) में रेंडर करके उसी फ़ोल्डर में सहेजता है, या प्रिंट डायलॉग से PDF निर्यात करता है',
  pluginCodeNavDesc: 'कोड प्रीव्यू नेविगेशन: फ़ाइल प्रकार से भाषा पहचानकर सिंटैक्स हाइलाइट, सिंबल आउटलाइन (क्लास/मेथड/वेरिएबल फ़िल्टर + एक-क्लिक जंप), फ़ाइल में खोज (सभी मैच हाइलाइट, पिछला/अगला, केस मैच) — codex-design एडिटर में कोड फ़ाइल प्रीव्यू संभालता है',
  pluginSuhuangScrollDesc: 'स्थानीय Suhuang Scroll Runtime को DSH सेटिंग्स और codex-design से जोड़ता है, ताकि मॉडल कॉन्फ़िगरेशन, कनेक्शन परीक्षण और निरंतर ग्रेडिंग नियंत्रण उपलब्ध हों; Suhuang Scroll Runtime और codex-design आवश्यक हैं',
  pluginBetterOverleafDesc: 'codex-design के लिए Overleaf टैब: सीधे CDP ब्राउज़र से लॉगिन (तीसरे पक्ष का Chromium समर्थित), प्रोजेक्ट सूची/स्विच, <workspace>/overleaf/ में स्थानीय git मिरर, रीड-ओनली API फ़ॉलबैक के साथ द्विदिश git सिंक, और फ़ाइल प्रीव्यू साइडबार वर्कबेंच से',
  ...
  pluginServerDeckDesc: 'सर्वर कार्ड डैशबोर्ड: प्रत्येक होस्ट के लिए एक कार्ड जिसमें ऑनलाइन स्थिति, OS, अपटाइम और CPU/मेमोरी/डिस्क उपयोग व लेटेंसी दिखती है; कार्ड पर क्लिक करके इंटरैक्टिव xterm.js टर्मिनल खोलें; ~/.ssh/config एक-क्लिक इंपोर्ट (git-hosting उपनाम स्वतः छोड़े जाते हैं)। codex-design इंस्टॉल होने पर नेटिव 「Servers」 टैब पंजीकृत होता है, अन्यथा स्वतंत्र दराज़ बना रहता है',
  ...
  pluginVideoPreviewDesc: 'codex-design एडिटर के लिए इनलाइन वीडियो पूर्वावलोकन (.mp4/.webm/.mov/.mkv/.avi आदि), HTTP Range (206) समर्थन के साथ समर्पित /video होस्ट रूट द्वारा समर्थित — स्क्रबिंग काम करता है और फ़ाइलें 20MB mediaLimit द्वारा सीमित नहीं हैं',
  ...
  pluginEgoBrowserDesc: 'DeepSeek Harness के लिए एजेंट ब्राउज़र: 32 ego_* टूल असली Chromium चलाते हैं; साइडबार में नेटिव «ego browser» टैब एजेंट के हर विज़िट किए गए पेज को लाइव दिखाता है — आप क्लिक, ड्रैग और टाइप करके नियंत्रण ले सकते हैं। codex-design मौजूद होने पर टैब स्वतः रजिस्टर होता है, अन्यथा फ्लोटिंग बबल के रूप में दिखता है',
  ...
  codexThemeTitle: 'Codex थीम',
  codexThemeDesc: 'टर्मिनल की मूल Codex पैलेट (लगभग काला कैनवास + विशिष्ट हरा एक्सेंट) पूरे Harness UI पर लागू करता है।',
  codexThemeApply: 'Codex थीम लागू करें',
  codexThemeRestore: 'सिस्टम लाइट / डार्क का पालन करें',
  codexThemeActive: 'Codex थीम लागू है',
  codexSessions: 'सत्र',
  codexActiveSessions: 'वर्तमान सत्र',
  codexArchived: 'संग्रहीत',
  codexArchivedEmpty: 'कोई संग्रहीत सत्र नहीं',
  codexRestore: 'पुनर्स्थापित करें',
  codexDelete: 'हटाएँ',
  codexDeleteConfirm: 'सत्र «{name}» को स्थायी रूप से हटाएँ? इस सत्र का संवाद लॉग हटा दिया जाएगा और उसे पुनर्स्थापित नहीं किया जा सकेगा।',
  codexUnarchiveFailed: 'पुनर्स्थापित करना विफल',
  codexDeleteFailed: 'हटाना विफल',
  codexTokens: 'डिज़ाइन टोकन',
  codexTokensDesc: 'वे UI टोकन जिन्हें Codex थीम ओवरराइड करती है: लगभग काला कैनवास, हेयरलाइन स्ट्रोक, टर्मिनल-हरा एक्सेंट।',
  codexViewerTitle: 'Codex डिज़ाइन',
  codexViewerEmpty: 'इस फ़ाइल में कोई पहचानने योग्य डिज़ाइन टोकन नहीं है।',
}
