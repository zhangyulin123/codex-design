...
export const tr: Record<string, string> = {
  ...
  pluginOfficeDesc: 'codex-design düzenleyicisi için Office üçlüsü önizlemesi (.docx / .xlsx / .pptx); ağır Office oluşturma kitaplıklarını çekirdek paketin dışında tutar, isteğe bağlı kurulur',
  pluginFlowglassDesc: 'Canlı oturum akış grafiği: kullanıcı, asistan ve araç çağrıları için üç şeritli kulvar; paralel gruplar, alt aracı dalları, derinlemesine inme ve canlı durum; codex-design kuruluyken yerli «Flowglass» sekmesi kaydeder, kurulmadığında bağımsız çekmecesi korunur',
  ...
  pluginGithubWorkbenchDesc: 'GitHub Workbench sekmesi: uzak depo ağacı + Issues / Pull requests / Actions tam yazma desteğiyle — Issue/PR oluşturma, yorum yapma, düzenleme, kapatma/yeniden açma, squash·merge·rebase birleştirme (güçlü onay), CI’yi yeniden çalıştırma/iptal etme; repo değiştirici erişilebilir depoları otomatik listeler ve genel depolarda arama yapar; codex-design yoksa bağımsız sağ panele geri düşer',
  pluginMdExportDesc: 'codex-design Markdown araç çubuğuna «Dışa aktar» düğmesi ekler: geçerli .md dosyasını tek tıkla bağımsız HTML biçimine dönüştürür (tablolar/kod blokları/Mermaid diyagramları gömülü, düzen önizleme temasını izler) ve .md dosyasının yanına kaydeder ya da yazdırma penceresinden PDF dışa aktarır',
  pluginCodeNavDesc: 'Kod önizleme gezinmesi: dosya türünden dili otomatik algılayıp söz dizimini vurgular, simge şeması (sınıf/yöntem/değişken filtreleri + tek tıkla atlama) ve dosya içi arama (tüm eşleşmeleri vurgula, önceki/sonraki, büyük/küçük harf duyarlı) — codex-design düzenleyicisinde kod dosyası önizlemesini devralır',
  pluginSuhuangScrollDesc: 'Yerel Suhuang Scroll Runtime ortamını model yapılandırması, bağlantı testi ve kesintisiz değerlendirme denetimi için DSH ayarlarına ve codex-design öğesine bağlar; Suhuang Scroll Runtime ve codex-design gerektirir',
  pluginBetterOverleafDesc: 'codex-design için Overleaf sekmesi: doğrudan CDP tarayıcı girişi (üçüncü taraf Chromium destekli), proje listesi/geçiş, <workspace>/overleaf/ altında yerel git aynaları, salt okunur API yedekli çift yönlü git senkronizasyonu ve dosya önizlemesi kenar çubuğu workbench üzerinden',
  ...
  pluginVideoPreviewDesc: 'codex-design düzenleyicisinde satır içi video önizlemesi (.mp4/.webm/.mov/.mkv/.avi vb.); HTTP Range (206) destekli özel /video sunucu rotasıyla — ilerleme çubuğu sürükleme çalışır ve 20MB mediaLimit ile sınırlanmaz',
  ...
  codexThemeTitle: 'Codex teması',
  codexThemeDesc: 'Terminale özgü Codex paletini (neredeyse siyah tuval, imza yeşili vurgu) Harness arayüzünün tamamına uygular.',
  codexThemeApply: 'Codex temasını uygula',
  codexThemeRestore: 'Sistem açık / koyu temasını izle',
  codexThemeActive: 'Codex teması etkin',
  codexSessions: 'Oturumlar',
  codexActiveSessions: 'Geçerli oturumlar',
  codexArchived: 'Arşivlenenler',
  codexArchivedEmpty: 'Arşivlenmiş oturum yok',
  codexRestore: 'Geri yükle',
  codexDelete: 'Sil',
  codexDeleteConfirm: '«{name}» oturumu kalıcı olarak silinsin mi? Bu oturumun konuşma kaydı silinir ve kurtarılamaz.',
  codexUnarchiveFailed: 'Geri yükleme başarısız',
  codexDeleteFailed: 'Silme başarısız',
  codexTokens: 'Tasarım belirteçleri',
  codexTokensDesc: 'Codex temasının geçersiz kıldığı arayüz belirteçleri: neredeyse siyah tuval, ince çizgiler, terminal yeşili vurgu.',
  codexViewerTitle: 'Codex tasarımı',
  codexViewerEmpty: 'Bu dosyada tanınabilir bir tasarım belirteci yok.',
}
